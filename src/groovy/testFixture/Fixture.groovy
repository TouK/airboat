...
class Fixture {
    ...
    public static final String PROJECT_CODEREVIEW_REPOSITORY_URL = Constants.PROJECT_CODEREVIEW_REPOSITORY_URL
    static String DEFAULT_PROJECT_LOCATION_IN_DEVELOPMENT_ENVIRONMENT = "/tmp/projekt"
